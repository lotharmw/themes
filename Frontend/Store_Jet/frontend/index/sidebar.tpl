        ...
        {block name="frontend_index_left_inner"}
                ...
                <div class="navigation--smartphone">
                    <ul class="navigation--list ">
                        ...
                        {block name="frontend_index_left_categories_close_menu"}
                            <li class="navigation--entry entry--close-off-canvas" style="width: 50%; margin-left: auto; margin-right: auto">
                                <picture>
            ...
            {block name='frontend_index_left_categories_wrapper'}
                <div class="sidebar--categories-wrapper"
                     {* always read the all categories instead of sub categories*} 
